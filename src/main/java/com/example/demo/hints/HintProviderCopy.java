...
public class HintProviderCopy implements InlayHintsProvider<HintSettings> {
...
//        return new HintCollector();
        ...
        RealtimeState.getInstance().setCurrentComplexity(new Analyzer().readPsiFile(file).count());
